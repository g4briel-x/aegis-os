"""Persistent orchestration result storage for Aegis OS."""
...
class PersistedExecutionOrchestration:
    """Paths updated while persisting orchestration results."""
    ...
    def to_dict(self) -> dict[str, Any]:
        """Serialize persisted orchestration information."""
...
class ExecutionOrchestrationStore:
    ...
    def persist(
        ...
        """Persist one successful orchestration result."""
        ...
        return PersistedExecutionOrchestration(
            workspace_path=workspace_path,
    ...
    def _validate_result(
        ...
        """Validate orchestration and storage identities."""

        if not result.ok:
            raise ValueError(
                "Only a successful orchestration "
        ...
        if (
            ...
            raise ValueError(
                "Orchestration session ID does not "
        ...
        if (
            ...
            raise ValueError(
                "Orchestration workspace ID does not "
                "match the stored workspace."
            )

        if not result.events:
            raise ValueError(
                "Orchestration result contains "
                "no audit events."
            )
        ...
        for event in result.events:
            if (
                ...
                raise ValueError(
                    ...
                    "match the orchestration session."
                )
            ...
            if (
                ...
                raise ValueError(
                    ...
                    "match the orchestration workspace."
                )
