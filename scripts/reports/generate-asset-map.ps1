...
.USAGE
pwsh -ExecutionPolicy Bypass -File scripts\reports\generate-asset-map.ps1
#>
...
$reportLines.Add("# Aegis OS - Asset Map")
$reportLines.Add("")
$reportLines.Add("Generated by:")
$reportLines.Add("")
$reportLines.Add('```text')
$reportLines.Add("scripts/reports/generate-asset-map.ps1")
$reportLines.Add('```')
$reportLines.Add("")
$reportLines.Add("## Assets")
$reportLines.Add("")
$reportLines.Add("| ID | Name | Type | Domain | Path |")
$reportLines.Add("|---|---|---|---|---|")
...
$reportLines.Add("")
$reportLines.Add("> Asset maps make registered Aegis OS assets easier to inspect and navigate.")
